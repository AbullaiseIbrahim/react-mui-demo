...
const MuiAlert = () => {
    return (
        <Stack spacing={2}>
            ...
            <Alert variant='filled' severity='success' icon={<CheckIcon fontSize='inherit' /> } action={ <Button color='inherit' size='small' >Undo</Button> } > <AlertTitle>Success</AlertTitle> This is an success alert</Alert>
        </Stack>
    )
}
